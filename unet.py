...
proj_dir = './'
def find_epoch(index):
    files = os.listdir(proj_dir)
    for file in files:
        if file.endswith('.pth'):
            # print(file)
            x = file.split('-')
            if index == int(x[0].replace('Epoch','')):
                return file
...
class uNet(object):
    ...
    #-----------------------------------------#
    _defaults = {
        "model_path"        :   proj_dir+find_epoch(64),
    ...
    def generate(self):
        ...
        if self.num_classes<= 21:
            self.colors = [ (0, 0, 0), (62, 62, 62), (126, 126, 126), (150,150, 150), (165, 165, 165), (180, 180, 180), 
                    (246, 246, 246), (255, 255, 255), (192, 0, 0), (64, 128, 0), (192, 128, 0), (64, 0, 128), (192, 0, 128), 
